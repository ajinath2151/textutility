  ...
  <div className="container-fluid">
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <div className='d-flex'>
        ...
        <div className='bg-link rounded mx-2 border' onClick={()=>{props.toggleMode('link')}} style={{height:'20px' , width:'20px', cursor:'pointer'}}></div>
        <div className='bg-dark rounded mx-2 border' onClick={()=>{props.toggleMode('dark')}} style={{height:'20px' , width:'20px', cursor:'pointer'}}></div>
        <div className='bg-light rounded mx-2 border' onClick={()=>{props.toggleMode('light')}} style={{height:'20px' , width:'20px', cursor:'pointer'}}></div>
        <div className='bg-info rounded mx-2' onClick={()=>{props.toggleMode('info')}} style={{height:'20px' , width:'20px', cursor:'pointer'}}></div>
      </div>

      {/* // toggle mode button code for dark and light mode of screen
